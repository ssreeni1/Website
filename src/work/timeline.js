    ...
    render() {
        ...
        this.container.innerHTML = `
            <div class="work-about">
                <p>Hi, I'm Saneel. I'm usually based in NYC and SF, but often in HK, SGP and KR.</p>
                <p>The through-line of my <a href="https://www.linkedin.com/in/snlsrn/" target="_blank" rel="noopener noreferrer">work</a> is a simple question: what happens when genuinely new technology meets genuinely old industries?</p>

                <p>I've explored this by building (<a href="https://ritual.net" target="_blank" rel="noopener noreferrer">Ritual</a>, <a href="https://alkimiya.io" target="_blank" rel="noopener noreferrer">Alkimiya</a>), by investing at the earliest stages (<a href="https://accomplice.co" target="_blank" rel="noopener noreferrer">Accomplice</a>, <a href="https://polychain.capital" target="_blank" rel="noopener noreferrer">Polychain</a>), and by trading public markets. I studied EECS and Business Administration at UC Berkeley's <a href="https://met.berkeley.edu/" target="_blank" rel="noopener noreferrer">M.E.T. program</a>. Go Bears!<br/><br/> I have been immensely fortunate to work with and learn from some pretty exceptional people through these things, and that remains a core driving factor for me. All my work has primarily been in crypto and AI, but I'm now dedicating more of my time to branch out.</p>
                ...
                <ul>
                    ...
                    <li>wisdom from long history, anthropology, and applied mimetics: the Bhagavad Gita, the Bible, Girard's mimetic theory, the Meditations of Marcus Aurelius, etc.</li>
                </ul>

                <p>Select investments: a mix of personal and fund investments, most, if not all, made at the seed / pre-seed stage.</p>
                <ul>
                    <li><a href="https://nof1.ai/about" target="_blank" rel="noopener noreferrer">Nof1</a></li>
                    <li><a href="https://arcana.io/" target="_blank" rel="noopener noreferrer">Arcana Analytics</a></li>
                    <li><a href="https://www.tomo.ai/" target="_blank" rel="noopener noreferrer">Tomo</a></li>
                    <li><a href="https://www.monkeytilt.com/" target="_blank" rel="noopener noreferrer">MonkeyTilt</a></li>
                    <li><a href="https://www.modernintelligence.ai/" target="_blank" rel="noopener noreferrer">Modern Intelligence</a></li>
                    <li>a few more on the way in {applied AI, robotics, compute}, currently in stealth and to be announced later</li>
                </ul>
            </div>
        `;
